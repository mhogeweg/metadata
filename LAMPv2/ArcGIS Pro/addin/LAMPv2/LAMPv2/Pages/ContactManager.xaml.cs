...
namespace LAMPv2.Pages
{
  internal class ContactManagerSidebarLabel : ISidebarLabel
  {
    ...
    {
      get { return LAMPv2.Properties.Resources.CFG_LBL_CONTACT_MGR; }
    }
  }
  /// <summary>
  ...
  internal partial class MTK_ContactManager : EditorPage
  {
    ...
    public void OnUnCheck(object sender, RoutedEventArgs e)
    {
      ...
      if (false == check && "external".Equals(tagNode.InnerText))
      {
        ...
        // show dialog
        MessageBoxResult result = ArcGIS.Desktop.Framework.Dialogs.MessageBox.Show(LAMPv2.Properties.Resources.LBL_CM_Confirm, LAMPv2.Properties.Resources.LBL_CM_ConfirmTitle, button, icon);
