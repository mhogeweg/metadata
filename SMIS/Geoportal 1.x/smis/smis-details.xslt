...
<xsl:stylesheet version="1.0" 
   ...
   xmlns:sdsfie="http://metadata.ces.mil/dse/ns/DISDI/sdsfie" > 

  <xsl:output indent="yes" method="html" omit-xml-declaration="yes"/>
  
  <xsl:template match="/sdsfie:MD_Metadata|/sdsfie:MI_Metadata">
    <style>
			.iso_section_title {margin-top: 18px;font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12pt; font-weight: bold; color: #333333}
    ...
    <div class="iso_body">
      ...
      <xsl:if test="count(/sdsfie:MD_Metadata/gmd:distributionInfo)>0">
        <xsl:call-template name="Distribution_Info"/>
      </xsl:if>
      <xsl:if test="count(/sdsfie:MD_Metadata/gmd:dataQualityInfo)>0">
  ...
  <xsl:template name="Page_Title">
    <h1 class="toolbarTitle">
      <xsl:value-of select="/sdsfie:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:title/gco:CharacterString"/>
    </h1>
    <hr/>
  </xsl:template>
  <xsl:template name="Metadata_Info">
    ...
    <dl>
      <xsl:for-each select="/sdsfie:MD_Metadata/gmd:fileIdentifier">
        <dt>
          <em>
            <xsl:call-template name="get_property">
          ...
          <xsl:value-of select="/sdsfie:MD_Metadata/gmd:fileIdentifier/gco:CharacterString"/>
        </dt>
      </xsl:for-each>
      ...
      <dt>
        <em>
          <xsl:call-template name="get_property">
            <xsl:with-param name="key">catalog.iso19139.smis.icm.label</xsl:with-param>
          </xsl:call-template>: </em>
        <dl>
      <!-- ism:DESVersion -->    
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.smis.icm.ism.desVersion</xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:value-of select="/sdsfie:MD_Metadata/@ism:DESVersion"/>
        </dt>
      ...
      <!-- ntk:DESVersion -->
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.smis.icm.ntk.desVersion</xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:value-of select="/sdsfie:MD_Metadata/@ntk:DESVersion"/>
        </dt>
      ...
      <!-- ism:resourceElement -->
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.smis.icm.resourceElement</xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:value-of select="/sdsfie:MD_Metadata/@ism:resourceElement"/>
        </dt>
      ...
      <!-- ism:createDate -->
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.smis.icm.createDate</xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:value-of select="/sdsfie:MD_Metadata/@ism:createDate"/>
        </dt>
      ...
      <!-- ism:ownerProducer -->
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.smis.icm.ownerProducer</xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:value-of select="/sdsfie:MD_Metadata/@ism:ownerProducer"/>
        </dt>
      ...
      <!-- ism:classification -->
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.smis.icm.classification</xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:value-of select="/sdsfie:MD_Metadata/@ism:classification"/>
        </dt>
      ...
      <!-- ism:compliesWith -->
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.smis.icm.compliesWith</xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:value-of select="/sdsfie:MD_Metadata/@ism:compliesWith"/>
        </dt>
      </dl>
    </dt>
      
      <xsl:if test="count(/sdsfie:MD_Metadata/gmd:language) > 0">
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.MD_Metadata.<xsl:value-of select="local-name(/sdsfie:MD_Metadata/gmd:language)"/>
              </xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:choose>
            <xsl:when test=" string-length(/sdsfie:MD_Metadata/gmd:language/gmd:LanguageCode/@codeListValue) > 0">
              <xsl:call-template name="get_property">
                <xsl:with-param name="key">catalog.mdCode.language.iso639_2.<xsl:value-of select="/sdsfie:MD_Metadata/gmd:language/gmd:LanguageCode/@codeListValue"/>
                </xsl:with-param>
              </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
              <xsl:value-of select="/sdsfie:MD_Metadata/gmd:language/gco:CharacterString"/>
            </xsl:otherwise>
          </xsl:choose>
        </dt>
      </xsl:if>
      <xsl:if test="count(/sdsfie:MD_Metadata/gmd:characterSet) > 0">
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.MD_Metadata.characterSet</xsl:with-param>
            </xsl:call-template>: </em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.MD_CharacterSetCode.<xsl:value-of select="/sdsfie:MD_Metadata/gmd:characterSet/gmd:MD_CharacterSetCode/@codeListValue"/>
              </xsl:with-param>
            </xsl:call-template>
        </dt>
      </xsl:if>
      <xsl:if test="/sdsfie:MD_Metadata/gmd:parentIdentifier">
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.MD_Metadata.parentIdentifier</xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:value-of select="/sdsfie:MD_Metadata/gmd:parentIdentifier/gco:CharacterString"/>
        </dt>
      </xsl:if>
      <xsl:if test="count(/sdsfie:MD_Metadata/gmd:hierarchyLevel/gmd:MD_ScopeCode)>0">
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.MD_Metadata.hierarchyLevel</xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:call-template name="get_property">
            <xsl:with-param name="key">catalog.iso19139.MD_ScopeCode.<xsl:value-of select="/sdsfie:MD_Metadata/gmd:hierarchyLevel/gmd:MD_ScopeCode/@codeListValue"/>
            </xsl:with-param>
          </xsl:call-template>
        </dt>
      </xsl:if>

      <xsl:if test="count(/sdsfie:MD_Metadata/gmd:hierarchyLevelName/sdsfie:ScopeAmplificationCode)>0">
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.MD_ScopeAmplificationCode</xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:call-template name="get_property">
            <xsl:with-param name="key">catalog.iso19139.MD_ScopeAmplificationCode.<xsl:value-of select="/sdsfie:MD_Metadata/gmd:hierarchyLevelName/sdsfie:ScopeAmplificationCode/@codeListValue"/>
            </xsl:with-param>
          </xsl:call-template>
        </dt>
      </xsl:if>

      <xsl:for-each select="/sdsfie:MD_Metadata/gmd:contact">
        <dt>
          <em>
            <xsl:call-template name="get_property">
      ...
      <xsl:if test="/sdsfie:MD_Metadata/gmd:dateStamp">
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.MD_Metadata.<xsl:value-of select="local-name(/sdsfie:MD_Metadata/gmd:dateStamp)"/>
              </xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:value-of select="/sdsfie:MD_Metadata/gmd:dateStamp/gco:Date"/>
        </dt>
      </xsl:if>
      <xsl:if test="/sdsfie:MD_Metadata/gmd:metadataStandardName">
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.MD_Metadata.metadataStandardName</xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:value-of select="/sdsfie:MD_Metadata/gmd:metadataStandardName/sdsfie:MetadataStandardNameCode/@codeListValue"/>
        </dt>
      </xsl:if>
      <xsl:if test="/sdsfie:MD_Metadata/gmd:metadataStandardVersion">
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.MD_Metadata.metadataStandardVersion</xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:value-of select="/sdsfie:MD_Metadata/gmd:metadataStandardVersion/sdsfie:MetadataStandardVersion"/>
        </dt>
      </xsl:if>
    </dl>
  </xsl:template>
  <xsl:template name="Identification_Info">
    <xsl:for-each select="/sdsfie:MD_Metadata/gmd:identificationInfo">
  ...
  <xsl:template name="Distribution_Info">
    ...
    <dl>
      <xsl:for-each select="/sdsfie:MD_Metadata/gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat">
        <dt>
          <em>
            <xsl:call-template name="get_property">
      ...
      <xsl:for-each select="/sdsfie:MD_Metadata/gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine">
        <dt>
          <em>
            <xsl:call-template name="get_property">
      ...
      <xsl:for-each select="/sdsfie:MD_Metadata/gmd:distributionInfo/gmd:MD_Distribution/gmd:distributor">
        <dt>
          <em>
            <xsl:call-template name="get_property">
  ...
  <xsl:template name="Data_Quality_Info">
    ...
    <dl>
      <xsl:if test="/sdsfie:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:scope/gmd:DQ_Scope/gmd:level/gmd:MD_ScopeCode">
        <dt>
          <em>
            <xsl:call-template name="get_property">
          ...
          <xsl:call-template name="get_property">
            <xsl:with-param name="key">catalog.iso19139.MD_ScopeCode.<xsl:value-of select="/sdsfie:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:scope/gmd:DQ_Scope/gmd:level/gmd:MD_ScopeCode/@codeListValue"/>
            </xsl:with-param>
          </xsl:call-template>
        </dt>
      </xsl:if>
      <xsl:for-each select="/sdsfie:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:report/*/gmd:result">
      ...
      <xsl:for-each select="/sdsfie:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:lineage/gmd:LI_Lineage/gmd:statement">
        <dt>
          <em>
            <xsl:call-template name="get_property">
              <xsl:with-param name="key">catalog.iso19139.DQ_DataQuality.lineage</xsl:with-param>
            </xsl:call-template>: </em>
          <xsl:value-of select="/sdsfie:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:lineage/gmd:LI_Lineage/gmd:statement/gco:CharacterString"/>
        </dt>
      </xsl:for-each>
    </dl>
  </xsl:template>
  ...
  <xsl:template match="/sdsfie:MD_Metadata/gmd:distributionInfo/gmd:MD_Distribution/gmd:distributor">
    <dl>
  ...
  <xsl:template match="sdsfie:MD_Metadata/gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat">
    <dl>
  ...
  <xsl:template name="get_property">
    ...
    <xsl:choose>
      ...
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.001&quot; '>i18n.catalog.iso19139.MD_ScopeCode.attribute</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.002&quot; '>i18n.catalog.iso19139.MD_ScopeCode.attributeType</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.003&quot; '>i18n.catalog.iso19139.MD_ScopeCode.collectionHardware</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.004&quot; '>i18n.catalog.iso19139.MD_ScopeCode.collectionSession</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.005&quot; '>i18n.catalog.iso19139.MD_ScopeCode.dataset</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.006&quot; '>i18n.catalog.iso19139.MD_ScopeCode.series</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.007&quot; '>i18n.catalog.iso19139.MD_ScopeCode.nonGeographicDataset</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.008&quot; '>i18n.catalog.iso19139.MD_ScopeCode.dimensionGroup</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.009&quot; '>i18n.catalog.iso19139.MD_ScopeCode.feature</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.010&quot; '>i18n.catalog.iso19139.MD_ScopeCode.featureType</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.011&quot; '>i18n.catalog.iso19139.MD_ScopeCode.propertyType</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.012&quot; '>i18n.catalog.iso19139.MD_ScopeCode.fieldSession</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.013&quot; '>i18n.catalog.iso19139.MD_ScopeCode.software</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.014&quot; '>i18n.catalog.iso19139.MD_ScopeCode.service</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.015&quot; '>i18n.catalog.iso19139.MD_ScopeCode.model</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeCode.016&quot; '>i18n.catalog.iso19139.MD_ScopeCode.tile</xsl:when>
      ...
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_Metadata.hierarchyLevel&quot; '>i18n.catalog.iso19139.MD_Metadata.hierarchyLevel</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.MD_Metadata.hierarchyLevelName&quot; '>i18n.catalog.iso19139.MD_Metadata.hierarchyLevelName</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.smis.icm.label&quot; '>i18n.catalog.iso19139.smis.icm.label</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.smis.icm.ism.desVersion&quot; '>i18n.catalog.iso19139.smis.icm.ism.desVersion</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.smis.icm.ntk.desVersion&quot; '>i18n.catalog.iso19139.smis.icm.ntk.desVersion</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.smis.icm.resourceElement&quot; '>i18n.catalog.iso19139.smis.icm.resourceElement</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.smis.icm.createDate&quot; '>i18n.catalog.iso19139.smis.icm.createDate</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.smis.icm.classification&quot; '>i18n.catalog.iso19139.smis.icm.classification</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.smis.icm.ownerProducer&quot; '>i18n.catalog.iso19139.smis.icm.ownerProducer</xsl:when>
      <xsl:when test=' $key = &quot;catalog.iso19139.smis.icm.compliesWith&quot; '>i18n.catalog.iso19139.smis.icm.compliesWith</xsl:when>
	  <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeAmplificationCode&quot; '>i18n.catalog.iso19139.MD_ScopeAmplificationCode</xsl:when>
	  <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeAmplificationCode.cell&quot; '>i18n.catalog.iso19139.MD_ScopeAmplificationCode.cell</xsl:when>
	  <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeAmplificationCode.collection&quot; '>i18n.catalog.iso19139.MD_ScopeAmplificationCode.collection</xsl:when>
	  <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeAmplificationCode.notApplicable&quot; '>i18n.catalog.iso19139.MD_ScopeAmplificationCode.notApplicable</xsl:when>
	  <xsl:when test=' $key = &quot;catalog.iso19139.MD_ScopeAmplificationCode.theme&quot; '>i18n.catalog.iso19139.MD_ScopeAmplificationCode.theme</xsl:when>
